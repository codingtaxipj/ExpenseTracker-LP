...
userid
year
maxMonth : {month : m , total : t }
minMonth : {month : m , total : t }

maxPrime : {name:p,total:t}
minPrime : {name:p,total:t}

maxSub : [{prime:p,sub:s,total:t}]
minSub : [{prime:p,sub:s,total:t}]
