...
function App() {
  ...
  const addIncomeDataInList = (dataObject) => {
    updateEntryTable(
          ...
          <div className="p-[5rem]" >
            <div className="grid grid-cols-3">
              ...
              <div className="bg-[#f1f2f4] p-[2rem]">
                ...
                <AddIncomeModal addIncomeDataInList={addIncomeDataInList} IncomeModalRef={IncomeModalRef} closeModal={() => toggleIncomeModal()} ></AddIncomeModal>
                ...
                <AddExpenseModal ExpenseModalRef={ExpenseModalRef} closeModal={() => toggleExpenseModal()} ></AddExpenseModal>
              </div>
